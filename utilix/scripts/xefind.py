...
def parse_args():
    ...
    parser.add_argument(
        'data_type', 
        type=str, 
        help="The data type to check (e.g. peaklets, event_info, etc)"
    )
    ...
    source_group.add_argument(
        ...
        type=str, 
        nargs='+', 
        help="The source(s) to check (e.g. none, th-232, etc)"
    )
    source_group.add_argument(
        '--filename', 
        type=str, 
        help="The file with the run_ids to check"
    )
    source_group.add_argument(
        '--run_id', 
        type=str, 
        help="The single run_id to check"
    )
    ...
    parser.add_argument(
        '--livetime', 
        action='store_true', 
        help="Get the livetime instead of the number of runs"
    )
    parser.add_argument(
        '--debug', 
        action='store_true', 
